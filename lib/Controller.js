	...
	for(var action in this.routes) {
		...
		for(i=0, max=routePieces.length; i<max; i++) {
			...
			switch(routePart.substr(0, 1)) {
				...
				case "#": //IP
                    var replaced = urlPart.replace(/\b(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\b/g, "");
